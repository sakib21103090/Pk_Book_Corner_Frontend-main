...
import { createAuthorNameAsync } from "../../BookList/Components/BooksSlice";
...
const AddAuthor = () => {
  ...
  const onSubmit = (data) => {
    console.log(data);
    dispatch(createAuthorNameAsync(data));
  ...
  return (
    <form className="max-w-lg mx-auto bg-white shadow-lg rounded-lg p-8 mt-12" onSubmit={handleSubmit(onSubmit)}>
      <h2 className="text-2xl font-bold text-center text-gray-800 mb-8">Add New Author</h2>
      <div className="space-y-8">
        <div>
          ...
          <input
            ...
            id="value"
            name="value"
            placeholder="Enter author value"
